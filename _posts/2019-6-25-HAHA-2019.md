...
With some baseline understanding behind me and the details of the compeition set out, I started to look at the data for the compeition.  I don't speak Spanish but I viewed this as an advantage.  Since I could not engineer features I had to apply the process and believe that the process would sort out the details. My process was simple and followed method of transfer-learning that is the basis of Universal Langage Model Fine-tuning for Text Classification (ULMFiT).
...
# LM Training Corpus
I started with Spanish Wikipedia and tried to train an LM from there.  
