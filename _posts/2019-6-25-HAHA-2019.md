...
## Setting the seed
In working code for the core library, I had found setting the random seed (link stas?) to be very helpful. I got results that were identical so I could test out the code changes I was making. In talking with Piotr on the forums, he suggested using the seed as a hyper-parameter and selecting the seeds to see what the best classifer was that I could get.  I tried this out and sampled over 100 seeds and looked at the classifer validation F1 score.  Indeed, the results showed that 
