...
<img src="{{ site.baseurl }}/images/nlp_challenge_tweet.png" alt="nbsvm_tweet_image" width="240" height="240"/>
<!-- ![_config.yml]({{ site.baseurl }}/images/nlp_challenge_tweet.png =100x100) -->
